...
String.prototype.entityify=function(){return this.replace(/&/g,'&amp;').replace(/</g,'&lt;').replace(/>/g,'&gt;');};String.prototype.isAlpha=function(){return(this>='a'&&this<='z\uffff')||(this>='A'&&this<='Z\uffff');};String.prototype.isDigit=function(){return(this>='0'&&this<='9');};String.prototype.supplant=function(o,t){var msg=t==="error"?"[ERROR]: ":"[WARNING]: ";msg+=this;return msg.replace(/\{([^{}]*)\}/g,function(a,b){var r=o[b];return typeof r==='string'||typeof r==='number'?r:a;});};String.prototype.name=function(){if(ix.test(this)){return this;}
...
character=1;s=lines[line];line+=1;at=s.search(/ \t/);
s=s.replace(/\t/g,tab);at=s.search(cx);
...
r=parse(0,true);if(!t.block){if(r.id==='('&&r.left.id==='new'){warning("Do not use 'new' for side effects.");}
...
o.push(m+'<br>*/</pre>');}
o.push('</div>');}}
return o.join('');};itself.jslint=itself;itself.edition='2010-03-10';return itself;}());(function(a){var e,i,input;if(!a[0]){print("Usage: jslint.js file.js");quit(1);}
